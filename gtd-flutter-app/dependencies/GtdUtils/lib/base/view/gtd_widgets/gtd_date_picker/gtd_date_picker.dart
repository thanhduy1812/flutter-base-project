...
@immutable
class GtdDateRangePicker extends StatelessWidget {
  GtdDateRangePicker(
      {Key? key,
      ...
      this.navigationDirection = DateRangePickerNavigationDirection.vertical,
      this.allowViewNavigation = true,
      this.navigationMode = DateRangePickerNavigationMode.scroll,
      this.enableMultiView = true,
      this.controller,
      this.onViewChanged,
      ...
      this.extendableRangeSelectionDirection = ExtendableRangeSelectionDirection.forward})
  ...
  SfDateRangePickerThemeData _getPickerThemeData(SfDateRangePickerThemeData pickerTheme, ColorScheme colorScheme) {
    return pickerTheme.copyWith(
        ...
        viewHeaderTextStyle: pickerTheme.viewHeaderTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 14, fontFamily: 'Inter'),
        headerTextStyle: pickerTheme.headerTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 16, fontFamily: 'Inter'),
        trailingDatesTextStyle: pickerTheme.trailingDatesTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Inter'),
        leadingCellTextStyle: pickerTheme.leadingCellTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Inter'),
        activeDatesTextStyle: pickerTheme.activeDatesTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Inter'),
        ...
        disabledDatesTextStyle: pickerTheme.disabledDatesTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.38), fontSize: 13, fontFamily: 'Inter'),
        disabledCellTextStyle: pickerTheme.disabledCellTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.38), fontSize: 13, fontFamily: 'Inter'),
        selectionTextStyle: pickerTheme.selectionTextStyle ??
            TextStyle(color: colorScheme.onPrimary, fontSize: 13, fontFamily: 'Inter'),
        weekNumberTextStyle: pickerTheme.weekNumberTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Inter'),
        todayTextStyle:
            pickerTheme.todayTextStyle ?? TextStyle(color: colorScheme.primary, fontSize: 13, fontFamily: 'Inter'),
        todayCellTextStyle: pickerTheme.todayCellTextStyle ??
            // ignore: lines_longer_than_80_chars
            TextStyle(color: colorScheme.primary, fontSize: 13, fontFamily: 'Inter'),
  ...
  Widget _addScrollView(double width, double height, double actionButtonsHeight) {
    ...
    if (isHorizontal) {
      ...
      return Stack(children: <Widget>[
        ...
        Positioned(left: 0, top: topPosition + 8, right: 0, height: scrollViewHeight, child: scrollView),
        _getActionsButton(topPosition + scrollViewHeight, actionButtonsHeight)
      ]);
    }
  }
...
class _PickerHeaderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int j = 0; j < count; j++) {
      ...
      TextStyle? style =
          headerStyle.textStyle ?? const TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 16);
      if (hovering) {
