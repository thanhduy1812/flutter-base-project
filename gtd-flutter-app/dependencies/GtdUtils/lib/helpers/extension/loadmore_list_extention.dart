...
class GtdLoadMoreExtention extends StatefulWidget {
  ...
  @override
  GtdLoadMoreExtentionState createState() {
    return GtdLoadMoreExtentionState();
  }
}

class GtdLoadMoreExtentionState extends State<GtdLoadMoreExtention> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          final itemCount = _isSeparated ? _separatedItemCount() : widget.itemCount();
