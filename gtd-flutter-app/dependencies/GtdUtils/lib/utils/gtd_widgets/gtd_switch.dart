...
class GtdCustomSwitch extends StatefulWidget {
  ...
  const GtdCustomSwitch({
    ...
    this.toggleColorGradient,
    this.toggleColor = Colors.white,
    this.activeToggleColor,
    this.activeToggleColorGradient,
    this.inactiveToggleColorGradient,
    this.inactiveToggleColor = const Color.fromRGBO(229, 231, 235, 1),
    this.width = 52.0,
    this.height = 32.0,
  ...
  ///
  /// If the [activeSwitchBorder] or [inactiveSwitchBorder] is used, this property must be null.
  final Gradient? toggleColorGradient;
  ...
  /// If [inactiveToggleColor] is used and this property is null. the value of
  /// [Colors.white] will be used.
  final Gradient? activeToggleColorGradient;

  /// The color to use on the toggle of the switch when the given value is false.
  ///
  /// If [inactiveToggleColorGradient] is used and this property is null. the value of
  /// [Colors.white] will be used.
  final Gradient? inactiveToggleColorGradient;
...
class GtdCustomSwitchState extends State<GtdCustomSwitch> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(GtdCustomSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.value) {
      toggleColorGradient = widget.activeToggleColorGradient!;
