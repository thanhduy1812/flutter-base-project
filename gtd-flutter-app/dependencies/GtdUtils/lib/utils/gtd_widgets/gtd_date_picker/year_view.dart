...
abstract class _IYearViewRenderObject extends RenderBox
  ...
  TextStyle _updateCellTextStyle(
    ...
    if (!isEnableDate || isDisabledDate) {
      return cellStyle.disabledDatesTextStyle as TextStyle? ?? datePickerTheme.disabledCellTextStyle!;
    }
    ...
    if (isCurrentDate) {
      return cellStyle.todayTextStyle as TextStyle? ?? datePickerTheme.todayCellTextStyle!;
    }

    if (!isActiveDate && !_isHijri) {
      return cellStyle.leadingDatesTextStyle as TextStyle? ?? datePickerTheme.leadingCellTextStyle!;
    }
