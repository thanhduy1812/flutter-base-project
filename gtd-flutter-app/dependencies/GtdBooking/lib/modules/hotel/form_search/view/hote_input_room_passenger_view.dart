...
class HotelInputRoomPassengerView extends BaseView<HotelInputRoomPassengerViewModel> {
  ...
  HotelInputRoomPassengerView({super.key, required super.viewModel, this.onConfirm});
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: GtdBoxInfo(
                        title: "Người lớn",
                        subTitle: "${viewModel.totalAdultCount}",
                      ),
                    ),
                    const SizedBox(
                      width: 8,
                    ...
                    Expanded(
                      child: GtdBoxInfo(
                        title: "Trẻ em",
                        subTitle: "${viewModel.totalChildCount}",
                      ),
                    ),
                  ],
                ),
                                ...
                                return SlideTransition(
                                  position: animation.drive(
                                      Tween(begin: const Offset(2, 0.0), end: const Offset(0.0, 0.0))
                                          .chain(CurveTween(curve: Curves.easeInOut))),
                                  child: HotelRoomPickerView(viewModel: removeRoom),
                                );
                              });
                            }
                            setStateInputRoom(() => {});
...
extension HotelInputRoomPassengerViewHelper on HotelInputRoomPassengerView {
  static void showHotelPickerRoomAndPassengers(
    ...
    GtdPresentViewHelper.presentView(
        ...
        builder: Builder(
          builder: (context) {
            return HotelInputRoomPassengerView(
