...
class HotelResultCardItemModel {
  ...
  List<String> hotelAmentites = ["Wifi free", "Spa xông hơi", "Xe đưa đón", "Massage tận nơi", "Đồ nhậu tận răng"];
  ...
  factory HotelResultCardItemModel.fromHotelItemDTO(GtdHotelItemDTO hotelItemDTO) {
    HotelResultCardItemModel hotelResultCardItemModel = HotelResultCardItemModel()
      ...
      ..hotelAmentites = hotelItemDTO.amenities.map((e) => e.name).whereType<String>().toList()
      ...
      ..mapPoint = (hotelItemDTO.latitude != null && hotelItemDTO.longitude != null)
          ? GtdMapPoint(latitude: hotelItemDTO.latitude!, longitude: hotelItemDTO.longitude!)
          : null
