...
class DateItineraryView extends BaseView<DateItineraryViewModel> {
  ...
  const DateItineraryView({super.key, required super.viewModel, this.onChangedRoundTrip});
  @override
          ...
          child: Column(
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                        child: Text(
                      'flight.ROUNDTRIP',
                      style: TextStyle(fontWeight: FontWeight.w400, fontSize: 15, color: Colors.grey.shade900),
                    ).tr()),
                    GtdCustomSwitch(
              ...
              GtdTextField(
                ...
                leftIcon: GtdAppIcon.iconNamedSupplier(iconName: "calendar-grey.svg", width: 30),
