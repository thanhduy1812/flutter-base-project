...
class FinalBookingDetailPage
    extends PricingBottomPage<FinalBookingDetailPageViewModel> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(providers: [
      BlocProvider(
        create: (bookingDetailContext) => BookingResultCubit()
          ..finalBookingDetail(
      ...
      child: BlocBuilder<BookingResultCubit, BookingResultState>(
        builder: (bookingResultContext, bookingResultState) {
          return StreamBuilder(
            stream: BlocProvider.of<BookingResultCubit>(pageContext)
                ...
                return Column(
                  children: [
                    SizedBox(
                      ...
                      child: buildHeaderBookingNumber(context: pageContext),
                    ),
                    Expanded(
                      child: LayoutBuilder(
                              ...
                              SliverPadding(
                                ...
                                sliver: SliverToBoxAdapter(
                                  child: FinalBookingStatusView(
                                    viewModel: FinalBookingStatusViewModel(
                                      bookingDetailDTO:
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      viewModel.bookingDetailDTO
                                              ...
                                              null
                                          ? BoxContactInfo
                                              .contactInfoFormFromBookingDetail(
                                              contactInputInfo: viewModel
                                                  .bookingDetailDTO!
                                                  .contactBookingInfo!,
                                              context: context,
                                            )
                                      ...
                                      sliver: SliverToBoxAdapter(
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            BoxInsuranceInfo
                                                .buildListHorizontalInsuranceInfo(
                                              context: context,
                                              bookingDetailDTO:
                                                  viewModel.bookingDetailDTO!,
                                              showStatus: true,
