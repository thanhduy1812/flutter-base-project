...
class FlightSummaryItemViewModel extends BaseViewModel {
  ...
  factory FlightSummaryItemViewModel.fromItemDetail({required GtdFlightItemDetail flightItemDetail}) {
    ...
    viewModel.arrivalDate =
        flightItemDetail.flightItem.flightItemInfo?.destinationDateTime?.utcDate("dd/MM/yyyy") ?? "";
  ...
  factory FlightSummaryItemViewModel.fromFlightItem(
    ...
    final selectedCabin = flightItem.cabinOptions?.firstWhereOrNull((cabin) => cabin.isSelected == true);
    if (selectedCabin != null) {
      viewModel.cabinClass = '${'flight.item.cabinClassName'.tr(
        gender: selectedCabin.cabinClassName,
      )} '
