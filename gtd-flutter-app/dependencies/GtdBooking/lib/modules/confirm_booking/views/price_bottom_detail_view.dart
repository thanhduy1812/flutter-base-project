              ...
              children: [
                Row(
                  children: [
                    Expanded(
                      child: ListTile(
                        title: Text(itemPrice.shortTitle,
                            style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.w500,
                                color: itemPrice.subTitle.isEmpty ? Colors.grey.shade500 : Colors.grey.shade900)),
                        subtitle: itemPrice.subTitle.isEmpty
                            ? null
                            : Text(itemPrice.subTitle,
                                style:
                                    TextStyle(fontSize: 13, fontWeight: FontWeight.w400, color: Colors.grey.shade500)),
                      ),
                    ),
                    Text(itemPrice.price.toCurrency(),
                        textAlign: TextAlign.start,
                        style: itemPrice.type == GtdDisplayItemType.totalPrice
                            ? TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.grey.shade900)
                            : TextStyle(fontSize: 15, fontWeight: FontWeight.w500, color: Colors.grey.shade900)),
                  ],
                ),
                const Divider(
                  height: 1,
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(color: AppColors.boldText, fontSize: 15, fontWeight: FontWeight.w500),
                          ),
                          Text(
                ...
                .map((e) => Padding(
                      ...
                      child: Row(
                        children: [
                          Text(
                            e.shortTitle,
                            style: TextStyle(color: AppColors.subText, fontSize: 15, fontWeight: FontWeight.w400),
                          ),
                          e.type.icon,
                          const Spacer(),
                          Text(
            ...
            child: Row(
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: AppColors.currencyText, fontSize: 20, fontWeight: FontWeight.w600),
                )
              ],
            ),
          )
