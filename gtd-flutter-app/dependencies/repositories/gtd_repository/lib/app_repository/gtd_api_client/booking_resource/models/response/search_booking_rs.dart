...
class BookingInfoElement {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "contactInfos":
            contactInfos == null ? [] : List<BookingInfoContactInfo>.from(contactInfos!.map((x) => x.toJson())),
        "travelerInfos":
            travelerInfos == null ? [] : List<TravelerInfoElement>.from(travelerInfos!.map((x) => x.toJson())),
