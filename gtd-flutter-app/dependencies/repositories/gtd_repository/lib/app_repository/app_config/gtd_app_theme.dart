...
import 'package:gtd_repository/app_repository/app_config/app_fonts.dart';
import 'package:gtd_repository/app_repository/app_config/color_config/app_color.dart';

import 'color_config/color_status.dart';
...
abstract class GtdThemeData {
  static ThemeData get vibLightTheme => ThemeData(
        ...
        dividerTheme: const DividerThemeData(
          color: GTDCustomColors.dividerColor,
          thickness: 1,
          space: 0,
        ),
        dividerColor: GTDCustomColors.dividerColor,
        highlightColor: Colors.transparent,
        splashFactory: NoSplash.splashFactory,
        indicatorColor: GTDAppColors.mainColor,
        progressIndicatorTheme: ProgressIndicatorThemeData(color: GTDAppColors.mainColor),
  ...
  static ThemeData get gotadiB2CLightTheme => ThemeData(
        ...
        highlightColor: Colors.transparent,
        splashFactory: NoSplash.splashFactory,
        indicatorColor: GTDCustomColors.mainGreen,
        progressIndicatorTheme: ProgressIndicatorThemeData(color: GTDAppColors.mainColor),
        primaryColor: GTDCustomColors.mainGreen,
        textTheme: TextTheme(
          headlineLarge: const TextStyle(fontSize: 22, fontWeight: FontWeight.w700),
          headlineMedium: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600),
          headlineSmall: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600),
        ...
        extensions: <ThemeExtension<dynamic>>[
          ...
          const GtdAppGradientColor(
            startColor: GTDCustomColors.mainGreen,
            endColor: GTDCustomColors.mainGreen,
          ),
        ],
      );
  ...
  static ColorScheme _colorScheme(GTDAppSupplier appSupplier, ThemeMode themeMode) {
    return ColorScheme(
      primary: GTDCustomColors.mainAppColor(supplier: appSupplier, themeMode: themeMode),
      background: const Color(0xFFF5F5F5),
      brightness: Brightness.light,
      error: GTDCustomColors.mainRed,
      onBackground: const Color(0xFFF5F5F5),
      onError: GTDCustomColors.mainRed,
      onPrimary: GTDCustomColors.mainAppColor(supplier: appSupplier, themeMode: themeMode),
      onSecondary: GTDCustomColors.mainAppColor(supplier: appSupplier, themeMode: themeMode),
      onSurface: Colors.grey.shade900,
      secondary: GTDCustomColors.mainAppColor(supplier: appSupplier, themeMode: themeMode),
      surface: Colors.grey.shade300,
      tertiary: GTDCustomColors.lightMainAppColor(supplier: appSupplier, themeMode: themeMode),
    );
  }
  ...
  static GtdColorStatus _colorStatus(GTDAppSupplier appSupplier, ThemeMode themeMode) {
    if (appSupplier == GTDAppSupplier.vib) {
      return GtdColorStatus(
        success: GTDCustomColors.mainAppColor(supplier: appSupplier, themeMode: themeMode),
        ...
        bookingAccepted: GTDCustomColors.mainAppColor(supplier: appSupplier, themeMode: themeMode),
  ...
  static GtdColorBackgroundStatus _colorBackgroundStatus(GTDAppSupplier appSupplier, ThemeMode themeMode) {
    if (appSupplier == GTDAppSupplier.vib) {
      return GtdColorBackgroundStatus(
        success: GTDCustomColors.lightMainAppColor(supplier: appSupplier, themeMode: themeMode),
