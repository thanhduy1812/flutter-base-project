                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: selectedIndexOfCategory == index ? FontWeight.bold : FontWeight.w400),
                    ),
                  ),
                );
              }),
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            ...
                            color: selectedIndexOfFeatured == index
                                ? AppConstantsColor.darkTextColor
                                : AppConstantsColor.unSelectedTextColor,
                            fontWeight: selectedIndexOfFeatured == index ? FontWeight.bold : FontWeight.w400),
                      ),
                    ),
                  );
                }),
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: FadeAnimation(
                          delay: 2,
                          child: Text("\$${model.price.toStringAsFixed(2)}", style: AppThemes.homeProductPrice),
                        ),
                      ),
                      Positioned(
                        left: 0,
                    ...
                    Positioned(
                      ...
                      child: FadeAnimation(
                        ...
                        child: Container(
                          ...
                          height: height / 42,
                          child: FittedBox(
                            child: Text("${model.name} ${model.model}", style: AppThemes.homeGridNameAndModel),
                          ),
                        ),
                      ),
                    ),
