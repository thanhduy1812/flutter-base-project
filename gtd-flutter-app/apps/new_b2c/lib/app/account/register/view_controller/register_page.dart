...
import 'package:gtd_utils/base/view/gtd_widgets/gtd_fade_indexed_stack.dart';
      ...
      builder: (context, snapshot) {
        ...
        return Padding(
          ...
          child: GtdTapWidget(
                      ...
                      descriptionWidget: Text.rich(
                        TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: viewModel.registerForm.control(RegisterFormControlNames.email.value).value,
                              style: TextStyle(
                                fontSize: 16,
                                color: GtdColors.inkBlack,
            ...
            backgroundColor: enabled ? GtdColors.appMainColor(pageContext) : GtdColors.snowGrey,
            radius: 24,
            child: Container(
              height: 48,
...
class _RegisterTabBarState extends State<RegisterTabBar> with TickerProviderStateMixin {
