            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                return Swiper(
                  ...
                  onTap: (index) {
                    context.push(Routes.checkoutscreen.path, extra: place_items[index]);
                  },
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  width: 80,
                  decoration:
                      BoxDecoration(borderRadius: BorderRadius.circular(30), color: Colors.black.withOpacity(0.4)),
                  child: Column(
                    children: [
                      FittedBox(
                        child: Text(
                          model.timing['days'] ?? '',
                          style: GoogleFonts.poppins(fontSize: 24, color: Colors.white, fontWeight: FontWeight.w400),
                        ),
                      ),
                      FittedBox(
                        child: Text(
